...
\geometry{verbose,tmargin=3.5cm,bmargin=4cm,lmargin=4cm,rmargin=4cm}
...
% \setmainfont{Caveat-VariableFont_wght.ttf}[
%   Path = C:/Users/herie/GitHub/Latex/
% ]

% % load the dash donor by FILE, not by family name
% \newfontface\DashFont{lmroman10-regular.otf}

% \renewcommand{\textendash}{{\DashFont\char"2013}}
% \renewcommand{\textemdash}{{\DashFont\char"2014}}

% \newunicodechar{–}{{\DashFont\char"2013}}
% \newunicodechar{—}{{\DashFont\char"2014}}

% --- Secciones y subsecciones ---
\usepackage{titlesec}
\newfontface\boldd{EB Garamond SemiBold}[Ligatures=TeX]
\newfontface\bolditalic{EB Garamond SemiBold Italic}[Ligatures=TeX]
\newfontface\extrabold{EB Garamond SemiBold}[Ligatures=TeX]
\newfontface\medium{EB Garamond  }[Ligatures=TeX]
...
\titleformat{\section}
    ...
    {\boldd\fontsize{16pt}{16pt}\selectfont}
    {\thesubsection}{10em}{}
\titlespacing*{\section}{0pt}{0pt}{24pt} % el primer {} es la sangría, el segundo {} es el espacio antes, el tercero {} es el espacio después
\titlespacing*{\subsection}{0pt}{0pt}{16pt} % el primer {} es la sangría, el segundo {} es el espacio antes, el tercero {} es el espacio después
...
\centering
\vspace*{4cm}
{\extrabold\fontsize{28pt}{28pt}\selectfont Riesgo de Mercado\par}
\vspace{1cm}

{\medium\fontsize{12pt}{12pt}\selectfont
{\large Curso:  Adiministración Actuarial de Riesgos: P26 LAT4062 1\par}
\vspace{.5em}
{\large Profesor:  Francisco Garcia Castilla\par}
\vspace{.5em}

{\large
\begin{tabular}{@{} l l @{}}
Pedro Jose Garcia Guevara      & ID: 176600 \\
Owen Paredes Conde        & ID: 178585 \\
Heriberto Espino Montelongo & ID: 175199 \\
% Goku del Cruz Azul        & ID: 175200 \\
\end{tabular}\par
}
...
Este trabajo analiza los fundamentos teóricos y aplicados de la administración actuarial del riesgo financiero, con énfasis en la medición y gestión del riesgo de mercado en portafolios de inversión. El documento integra elementos conceptuales, regulatorios y cuantitativos para ilustrar cómo las instituciones financieras identifican, cuantifican y administran sus exposiciones al riesgo bajo distintos marcos metodológicos. En particular, se examinan los principales enfoques utilizados para estimar pérdidas potenciales en portafolios financieros, incluyendo simulación histórica, simulación de Monte Carlo y el método paramétrico, así como medidas regulatorias como el Value at Risk (VaR), el Expected Shortfall (CVaR) y el VaR estresado.

A partir de datos de mercado reales, se construyen portafolios de activos financieros y se estiman sus distribuciones de rendimientos, estadísticas descriptivas y medidas de riesgo bajo distintos horizontes temporales. Asimismo, se discuten los requerimientos regulatorios de capital asociados al riesgo de mercado y su evolución en el marco de los acuerdos de Basilea. El trabajo también incorpora una reflexión crítica sobre la naturaleza del riesgo financiero a través del análisis de literatura especializada y de representaciones cinematográficas de crisis financieras recientes.

Finalmente, se discuten las propiedades teóricas de las medidas de riesgo, la modelación estocástica de precios de activos mediante movimiento browniano geométrico y aplicaciones prácticas en la toma de decisiones de gestión de riesgos dentro de instituciones financieras. En conjunto, el análisis busca integrar teoría actuarial, evidencia empírica y regulación financiera para comprender la medición del riesgo y su papel en la estabilidad del sistema financiero.
