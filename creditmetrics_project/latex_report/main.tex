...
\title{Reporte T\'ecnico del Proyecto CreditMetrics}
...
\begin{titlepage}
\centering
{\Huge Reporte T\'ecnico del Proyecto CreditMetrics\par}
\vspace{0.7cm}
{\Large Portafolio de 3 bonos independientes\par}
\vspace{1.2cm}
\includegraphics[width=0.95\textwidth]{00_portada_resumen.png}\par
\vspace{1.0cm}
{\large Documento LaTeX generado para explicar c\'omo funciona el c\'odigo, qu\'e resultados produce e interpretar las salidas visuales.\par}
\vfill
...
\input{sections/01_objetivo}

\chapter{Arquitectura y flujo del c\'odigo}
\input{sections/02_codigo}
...
\input{sections/05_interpretacion}

\appendix
\chapter{C\'omo compilar el reporte}
\input{sections/06_compilacion}
