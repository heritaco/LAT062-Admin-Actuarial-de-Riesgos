Esta secci\'on presenta las salidas visuales generadas por el propio proyecto en Python. 

\section*{Resumen del portafolio}
...
La tabla anterior resume las magnitudes centrales del ejercicio. El valor esperado a 1 a\~no es mayor que el valor actual, por lo que la p\'erdida esperada aparece con signo negativo. Eso refleja que, en promedio, los cupones domina a la p\'erdida esperada por migraci\'on crediticia.
